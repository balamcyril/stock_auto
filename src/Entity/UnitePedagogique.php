...
#[ORM\Entity]
#[ApiResource(normalizationContext: ['groups' => ['unite_pedagogique:read']],)]
...
class UnitePedagogique
{
    ...
    #[Vich\UploadableField(mapping: 'unite_pedagogique_images', fileNameProperty: 'image1')]
    ...
    #[Vich\UploadableField(mapping: 'unite_pedagogique_images', fileNameProperty: 'image2')]
     ...
     */
    #[ORM\OneToMany(targetEntity: Formation::class, mappedBy: 'unitePedagogique')]
    #[Groups(['unite_pedagogique:read'])]
    ...
    public function addFormation(Formation $formation): static
    {
        if (!$this->formations->contains($formation)) {
            ...
            $formation->setUnitePedagogique($this);
        }
    ...
    public function removeFormation(Formation $formation): static
    {
        if ($this->formations->removeElement($formation)) {
            ...
            if ($formation->getUnitePedagogique() === $this) {
                $formation->setUnitePedagogique(null);
            }
        }
