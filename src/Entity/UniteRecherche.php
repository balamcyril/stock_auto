...
class UniteRecherche
{
    ...
    #[Vich\UploadableField(mapping: 'unite_recherche_images', fileNameProperty: 'image1')]
    ...
    #[Vich\UploadableField(mapping: 'unite_recherche_images', fileNameProperty: 'image2')]
