...
class Brand
{
    ...
    #[Groups(['brand:read', 'brand:write', 'product:read', 'product_image:read', 'stock_movement:read', 'product_location:read'])]
    private ?int $id = null;
    ...
    #[Groups(['brand:read', 'product:read', 'product_image:read', 'stock_movement:read', 'product_location:read'])]
