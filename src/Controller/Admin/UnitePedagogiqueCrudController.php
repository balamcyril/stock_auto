...
class UnitePedagogiqueCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return UnitePedagogique::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('nom', 'Nom unité pédagogique'),
            TextField::new('sigle', 'Sigle unité pédagogique'),
            ...
            ImageField::new('image1', 'Image 1')
                ->setBasePath('/media/cache/resolve/thumbnail_800x570/uploads/unite_pedagogiques')
                ->hideOnForm(),
